...
export const GOLDEN_CASES: GoldenCase[] = [
  ...
  { id: "k08", argv: ["export", "--format", "xml"], creates: ["dir:lcm/tmp"], removes: [] },
  { id: "k09", argv: ["export"], creates: ["dir:lcm/tmp"], removes: [] },
  { id: "k10", argv: ["export", "--output", "out.json"], creates: ["dir:lcm/tmp"], removes: [] },

  { id: "k11", argv: ["import-knowledge"], creates: [], removes: [] },
  { id: "k12", argv: ["import-knowledge", "-h"], creates: [], removes: [] },
  { id: "k13", argv: ["import-knowledge", "missing.json"], creates: ["dir:lcm/tmp"], removes: [] },
  { id: "k14", argv: ["import-knowledge", "fixture.json", "--confidence", "2"], creates: ["dir:lcm/tmp"], removes: [] },
  {
    id: "k15",
    argv: ["import-knowledge", "fixture.json", "--dry-run"],
    creates: ["dir:lcm/tmp"], removes: [],
