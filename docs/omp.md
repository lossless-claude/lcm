...
7. Passive learning only sees the OMP tools translated to the extractor's names; `github`, `security_scan`, `checkpoint`, `rewind`, `todo` and the rest record nothing ([#546](https://github.com/lossless-claude/lcm/issues/546)).
